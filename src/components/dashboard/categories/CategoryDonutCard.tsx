...
export function CategoryDonutCard({ category, amount, percentage, color }: CategoryDonutCardProps) {
    return (
        <div className="flex-shrink-0 w-[220px] h-[243px] bg-white border border-secondary-50 rounded-[20px] p-5 flex flex-col items-center justify-center gap-3 hover:border-brand transition-all group">
            {/* Donut Chart */}
